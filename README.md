This will allow you to run hey with docker run instead of requiring go binaries on your current system.

`docker run moosebeandev/hey -z 12s -c 100 -m GET http://nginx-echo-headers.example.com/`
